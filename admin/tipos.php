...
<? include '_header.php';?>
<article>
	<? $sep=11; $sub=11.3; include '_menu.php';?>
	<div class="conteudo">
		<div class="linha">
			<div class="titulo">
				<h1>Todas os Tipos<!--<a href="/admin/categoria"><small>nova categoria</small></a>--><h1>
		...
		<div class="linha">
			<? $numero=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM tipo"));
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM tipo"));
			...
			<? $numero=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM tipo"));
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM tipo WHERE id=1"));
			$percentagem=round($num_per*100/$numero); ?>
			<div class="coluna2">
				<div class="corpo">
					<div class="linha">
		...
		<div class="linhaScroll">
			<div class="coluna1">
				<div class="corpo tabelaBorda">
					<div class="tabelaHead">TIPOS</div>
					<div class="linhaScroll">
						<table id="sortable" class="listagem">
							...
							while($linha = mysqli_fetch_array($query))
							{
	                            ...
	                            <tr id="linha_<? echo $id?>" class="<? echo $classe?>">
									<td>
										<a href="/admin/tipo/<?echo $id;?>" class="opcoes"><? echo $tipo?></a>
									</td>
									<td>
										<a href="/admin/tipo/<?echo $id;?>" class="opcoes"><span class="lnr lnr-pencil"></span>&nbsp;Editar</a>&nbsp;&nbsp;
					...
					<button class="btV margin-top20 floatr" onClick="window.location.href='/admin/tipo';">ADICIONAR NOVO</button>
					<div class="clear"></div>
				</div>
			</div>
		</div>
...
function apagar(){
	$.post("/admin/_noticia/js_del_tipo.php",{ id:id_del }) 
    .done(function( data ){
    	...
    	if(jsonRetorna!='TF'){
			...
			$.notific8('Este tipo não pode ser apagado.<br>Tem noticias associadas.', {heading: 'Erro', theme: 'ruby'});
		}
    });
}
</script>
