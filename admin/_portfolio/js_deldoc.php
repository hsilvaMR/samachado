...
$linha = mysqli_fetch_array(mysqli_query($lnk, "SELECT * FROM documentos WHERE id='$id'"));
$id_ficha = $linha["id_ficha"];
$nome = $linha["nome"];
$documento = $linha["documento"];

if($documento && file_exists('../..'.$documento)){ unlink('../..'.$documento); }
mysqli_query($lnk, "DELETE FROM documentos WHERE id='$id'");

$registo="Apagou documento ".$nome."( ".$documento." ) da ficha #".$id_ficha;
