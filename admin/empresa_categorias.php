...
<? include '_header.php';?>
<article>
	<? $sep=12; $sub=12.3; include '_menu.php';?>
	<div class="conteudo">
		<div class="linha">
			<div class="titulo">
		...
		<div class="linha">
			<? $numero=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM category"));
			$num_per=mysqli_num_rows(mysqli_query($lnk,"SELECT * FROM category"));
		...
		<div class="linhaScroll">
			<div class="coluna1">
				<div class="corpo tabelaBorda">
						...
						<table id="sortable" class="listagem">
							...
							while($linha = mysqli_fetch_array($query))
							{
	                            ...
	                            <tr id="linha_<? echo $id?>" class="<? echo $classe?>">
									<td><a href="/admin/empresa_categoria/<?echo $id;?>" class="opcoes"><? echo $categoria?></a></td>
									<td>
										<a href="/admin/empresa_categoria/<?echo $id;?>" class="opcoes"><span class="lnr lnr-pencil"></span>&nbsp;Editar</a>&nbsp;&nbsp;
					...
					<button class="btV margin-top20 floatr" onClick="window.location.href='/admin/empresa_categoria';">ADICIONAR NOVO</button>
					<div class="clear"></div>
				</div>
			</div>
		</div>
...
function apagar(){
	$.post("/admin/_empresa/js_del_cat.php",{ id:id_del }) 
    .done(function( data ){
    	...
    	if(jsonRetorna!='TF'){
			...
			$.notific8('Esta categoria não pode ser apagada.<br>Tem empresas associadas.', {heading: 'Erro', theme: 'ruby'});
		}
    });
}
</script>
