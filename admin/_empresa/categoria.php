...
if($id || $nome || $nome_en || $nome_fr || $nome_es){
	if($id){
		mysqli_query($lnk,"UPDATE category SET nome='$nome',nome_en='$nome_en',nome_fr='$nome_fr',nome_es='$nome_es' WHERE id='$id'");
	}
	else{
		mysqli_query($lnk, "INSERT INTO category(nome,nome_en,nome_fr,nome_es) VALUES ('$nome','$nome_en','$nome_fr','$nome_es')");
